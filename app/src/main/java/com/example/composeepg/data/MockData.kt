...
class MockData {
    ...
    fun createPrograms(): MutableList<ProgramRowItems> {
        return mutableListOf(
            ...
            ProgramRowItems(programID = 6, programName = "Program 6","https://raw.githubusercontent.com/Jasmeet181/mediaportal-us-logos/master/TV/.Light/AMC%20HD.png",programStart = "5.50", programEnd = "8.00", channelId = 1,false,false,false),
